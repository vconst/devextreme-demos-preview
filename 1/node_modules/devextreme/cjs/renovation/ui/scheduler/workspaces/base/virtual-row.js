/**
 * DevExtreme (cjs/renovation/ui/scheduler/workspaces/base/virtual-row.js)
...
var viewFunction = function(_ref) {
    ...
    return (0, _inferno.createComponentVNode)(2, _row.Row, {
        ...
        children: virtualCells.map((function(_, index) {
            return (0, _inferno.createComponentVNode)(2, _virtualCell.VirtualCell, null, index.toString())
        }))
    })
};
    ...
    _createClass(VirtualRow, [{
        ...
        get: function() {
            var _this$props = this.props,
                restProps = (_this$props.cellsCount, _this$props.children, _this$props.className, _this$props.height, _this$props.leftVirtualCellWidth, _this$props.rightVirtualCellWidth, _this$props.styles, _objectWithoutProperties(_this$props, ["cellsCount", "children", "className", "height", "leftVirtualCellWidth", "rightVirtualCellWidth", "styles"]));
            return restProps
        }
    }]);
    return VirtualRow
