...
var viewFunction = function(_ref) {
    ...
    return (0, _inferno.createVNode)(1, "tr", className, [hasLeftVirtualCell && (0, _inferno.createComponentVNode)(2, _virtualCell.VirtualCell, {
        width: leftVirtualCellWidth
    }), children, hasRightVirtualCell && (0, _inferno.createComponentVNode)(2, _virtualCell.VirtualCell, {
...
var Row = function(_BaseInfernoComponent) {
    ...
    _createClass(Row, [{
        ...
        get: function() {
            var leftVirtualCellWidth = this.props.leftVirtualCellWidth;
            return !!leftVirtualCellWidth
        }
    }, {
        key: "hasRightVirtualCell",
        get: function() {
            var rightVirtualCellWidth = this.props.rightVirtualCellWidth;
        ...
        get: function() {
            var _this$props = this.props,
                restProps = (_this$props.children, _this$props.className, _this$props.leftVirtualCellWidth, _this$props.rightVirtualCellWidth, _this$props.styles, _objectWithoutProperties(_this$props, ["children", "className", "leftVirtualCellWidth", "rightVirtualCellWidth", "styles"]));
            return restProps
        }
    }]);
    return Row
