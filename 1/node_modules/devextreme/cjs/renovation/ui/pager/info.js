...
var InfoText = function(_BaseInfernoComponent) {
    ...
    _createClass(InfoText, [{
        ...
        get: function() {
            ...
            return (0, _string.format)(this.infoText, ((void 0 !== this.props.pageIndex ? this.props.pageIndex : this.state.pageIndex) + 1).toString(), pageCount.toString(), totalCount.toString())
        }
    }, {
        key: "restAttributes",
        get: function() {
