    ...
    var registerComponentKoBinding = function(componentName, componentClass) {
        ...
        _knockout.default.bindingHandlers[componentName] = {
            init: function(domNode, valueAccessor) {
                ...
                return {
                    controlsDescendantBindings: componentClass.subclassOf(_ui.default) || componentClass.subclassOf(_base_widget.default) || componentClass.subclassOf(_draggable.default) || componentClass.subclassOf(_component.default)
                }
            }
        };
