...
var Overlay = _ui.default.inherit({
    _supportedKeys: function() {
        ...
        return (0, _extend.extend)(this.callBase(), {
            ...
            upArrow: function(e) {
                move.call(_this, -5, 0, e)
            },
            downArrow: function(e) {
                move.call(_this, 5, 0, e)
            },
            leftArrow: function(e) {
                move.call(_this, 0, -5, e)
            },
    ...
    _initResizeObserver: function() {
        ...
        this._resizeObserver = new _resize_observer.default({
            ...
            shouldSkipCallback: function(entries) {
    ...
    _areContentDimensionsRendered: function(entries) {
        ...
        var contentBox = null === (_entries$0$contentBox = entries[0].contentBoxSize) || void 0 === _entries$0$contentBox ? void 0 : _entries$0$contentBox[0];
        if (contentBox) {
    ...
    _animateShowing: function() {
        var _this$_getAnimationCo, _showAnimation$start, _showAnimation$comple, _this8 = this;
    ...
    _animateHiding: function() {
        var _this$_getAnimationCo2, _hideAnimation$start, _hideAnimation$comple, _this10 = this;
        ...
        this._animate(hideAnimation, (function() {
            ...
            null === (_this10$_actions = _this10._actions) || void 0 === _this10$_actions ? void 0 : _this10$_actions.onHidden();
    ...
    _renderGeometry: function(options) {
        ...
        if (visible && (0, _window.hasWindow)()) {
            ...
            var shouldRepeatAnimation = isAnimated && !(null !== options && void 0 !== options && options.forceStopAnimation) && _observeContentResize;
    ...
    _isContainerWindow: function() {
        ...
        return this._isWindow($container) || !(null !== $container && void 0 !== $container && $container.get(0))
    },
    ...
    _dispose: function() {
        ...
        null === (_this$_resizeObserver = this._resizeObserver) || void 0 === _this$_resizeObserver ? void 0 : _this$_resizeObserver.disconnect();
