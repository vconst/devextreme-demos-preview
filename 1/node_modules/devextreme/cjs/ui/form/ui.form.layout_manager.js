...
var LayoutManager = _ui.default.inherit({
    ...
    _renderFieldItem: function(item, $container) {
        ...
        if (helpText && isSimpleItem) {
            ...
            $editorParent.append((0, _renderer.default)("<div>").addClass(_constants.FIELD_ITEM_CONTENT_WRAPPER_CLASS).append($editor).append((0, _uiForm2.renderHelpText)(helpText, helpID)))
        }
    ...
    _renderLabel: function(labelOptions) {
        return (0, _uiForm2.renderLabel)(this._getRenderLabelOptions(labelOptions))
    },
