...
var Gantt = function(_Widget) {
    ...
    _proto._sort = function() {
        ...
        if (sortColumn || isClearSorting) {
            ...
            this._setGanttViewOption("sorting", isClearSorting ? void 0 : sortOptions)
        }
    ...
    _proto._optionChanged = function(args) {
        ...
        switch (args.name) {
            ...
            case "height":
                ...
                break;
            case "sorting":
                null === (_this$_ganttTreeList9 = this._ganttTreeList) || void 0 === _this$_ganttTreeList9 ? void 0 : _this$_ganttTreeList9.setOption("sorting", args.value);
                break;
            default:
                _Widget.prototype._optionChanged.call(this, args)
        }
