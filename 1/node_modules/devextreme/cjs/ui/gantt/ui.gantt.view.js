...
var GanttView = function(_Widget) {
    ...
    _proto.getGanttTasksData = function() {
        ...
        if (null !== sortingOptions && void 0 !== sortingOptions && sortingOptions.sortedItems && null !== sortingOptions && void 0 !== sortingOptions && sortingOptions.sortColumn) {
            return sortingOptions.sortedItems
        }
        return tasks
    };
    _proto._sort = function(args) {
        this._sortOptions = args;
        this._update(true);
        var selectedRowKey = this.option("selectedRowKey");
        this._selectTask(selectedRowKey)
    };
    _proto.getSortingOptions = function() {
