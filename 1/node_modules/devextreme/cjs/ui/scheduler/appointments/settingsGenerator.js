...
var DateGeneratorBaseStrategy = function() {
    ...
    _proto.generate = function(appointmentAdapter) {
        var itemResources = this.resourceManager.getResourcesFromItem(this.rawAppointment);
        var itemGroupIndices = this._getGroupIndices(itemResources, this.resourceManager);
    ...
    _proto._getGroupIndices = function(appointmentResources, resourceManager) {
        var result = [];
...
var DateGeneratorVirtualStrategy = function(_DateGeneratorBaseStr) {
    ...
    _proto2._createRecurrenceAppointments = function(appointment, groupIndices) {
        ...
        validGroupIndices.forEach((function(groupIndex) {
            var option = _this8._createRecurrenceOptions(appointment, groupIndex);
            var generatedStartDates = (0, _recurrence.getRecurrenceProcessor)().generateDates(option);
    ...
    _proto2._updateGroupIndices = function(appointments, groupIndices) {
        ...
        groupIndices.forEach((function(groupIndex) {
            var groupStartDate = _this9.viewDataProvider.getGroupStartDate(groupIndex);
            if (groupStartDate) {
    ...
    _proto2._getGroupIndices = function(resources, resourceManager) {
        var _groupIndices;
        var groupIndices = _DateGeneratorBaseStr.prototype._getGroupIndices.call(this, resources, resourceManager);
    ...
    _createClass(DateGeneratorVirtualStrategy, [{
        key: "groupCount",
        get: function() {
            return (0, _utils.getGroupCount)(this.resourceManager.loadedResources)
        }
    }]);
