...
var ResourceManager = function() {
    ...
    _proto.loadResourcesCore = function(groups) {
        var result = new _deferred.Deferred;
        var that = this;
        var deferreds = [];
    ...
    _proto.groupAppointmentsByResources = function(appointments, groups) {
        var result = {
            0: appointments
        };
    ...
    _proto.groupAppointmentsByResourcesCore = function(appointments, resources) {
    ...
    _proto.getAppointmentColor = function(options) {
    ...
    _proto.createReducedResourcesTree = function(appointments) {
