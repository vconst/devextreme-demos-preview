...
var _settingsGenerator = require("./appointments/settingsGenerator");
...
var Scheduler = function(_Widget) {
    ...
    _proto._getAppointmentSettingsGenerator = function(rawAppointment) {
        var workspace = this.getWorkSpace();
        return new _settingsGenerator.AppointmentSettingsGenerator({
            key: this.key,
    ...
    _proto._postponeResourceLoading = function() {
        ...
        var whenLoaded = this.postponedOperations.add("loadResources", (function() {
            ...
            return (0, _instanceFactory.getResourceManager)(_this.key).loadResources(groups)
        }));
    ...
    _proto._optionChanged = function(args) {
        ...
        switch (args.name) {
            ...
            case "disabledExpr":
                ...
                (0, _instanceFactory.getAppointmentDataProvider)(this.key).updateDataAccessors(_utils2.utils.dataAccessors.combine(this.key, this._dataAccessors));
    ...
    _proto._isAgenda = function() {
        return "agenda" === this.modelProvider.getViewRenderingStrategyName()
    };
    ...
    _proto.updateFactoryInstances = function() {
        ...
        if (!(0, _type.isDefined)(this.key)) {
            ...
            getDataAccessors: function(key) {
                return _utils2.utils.dataAccessors.combine(key, this._dataAccessors)
            }.bind(this)
        })
    };
    ...
    _proto._initAppointmentTemplate = function() {
        ...
        this._templateManager.addDefaultTemplates(_defineProperty({}, "item", new _bindable_template.BindableTemplate((function($container, data, model) {
            return _this3.getAppointmentsInstance()._renderAppointmentTemplate($container, data, model)
    ...
    _proto._getAppointmentsToRepaint = function() {
        ...
        var appointments = layoutManager.createAppointmentsMap(filteredItems);
    ...
    _proto._initMarkup = function() {
        ...
        if (this._isLoaded() || this._isDataSourceLoading()) {
            ...
            (0, _instanceFactory.getResourceManager)(this.key).loadResources(groups).done((function(resources) {
                _this4._initMarkupCore(resources);
                _this4._reloadDataSource()
            }))
        }
    };
    _proto.createAppointmentForm = function() {
        ...
        var scheduler = {
            getResourceManager: function() {
                return _this5.fire("getResourceManager")
            },
            getDataAccessors: function() {
                return _this5._dataAccessors
            },
            createComponent: function(element, component, options) {
                return _this5._createComponent(element, component, options)
            },
            getFirstDayOfWeek: function() {
                return _this5.option("firstDayOfWeek")
            },
            getStartDayHour: function() {
                return _this5.option("startDayHour")
            },
            getCalculatedEndDate: function(startDateWithStartHour) {
                return _this5._workSpace.calculateEndDate(startDateWithStartHour)
            }
        };
    ...
    _proto.createAppointmentPopup = function(form) {
        ...
        var scheduler = {
            ...
            getResourceManager: function() {
                return _this6.fire("getResourceManager")
            },
            ...
            getAppointmentFormOpening: function() {
                return _this6._actions.onAppointmentFormOpening
            },
            processActionResult: function(arg, canceled) {
                return _this6._processActionResult(arg, canceled)
            },
            addAppointment: function(appointment) {
                return _this6.addAppointment(appointment)
            },
            updateAppointment: function(sourceAppointment, updatedAppointment) {
                return _this6.updateAppointment(sourceAppointment, updatedAppointment)
            },
            updateScrollPosition: function(startDate, resourceItem, inAllDayRow) {
                _this6._workSpace.updateScrollPosition(startDate, resourceItem, inAllDayRow)
            }
        };
    ...
    _proto._getAppointmentTooltipOptions = function() {
        ...
        return {
            ...
            createFormattedDateText: function(appointment, targetedAppointment, format) {
                return _this7.fire("getTextAndFormatDate", appointment, targetedAppointment, format)
            },
            getAppointmentDisabled: function(appointment) {
                return (0, _appointmentAdapter.createAppointmentAdapter)(_this7.key, appointment).disabled
            }
        }
    };
    _proto.checkAndDeleteAppointment = function(appointment, targetedAppointment) {
        ...
        this._checkRecurringAppointment(appointment, targetedAppointment, targetedAdapter.startDate, (function() {
            _this8.deleteAppointment(appointment)
        }), true)
    };
    ...
    _proto._initMarkupCore = function(resources) {
        ...
        this._waitAsyncTemplate((function() {
            var _this9$_workSpaceReca;
            return null === (_this9$_workSpaceReca = _this9._workSpaceRecalculation) || void 0 === _this9$_workSpaceReca ? void 0 : _this9$_workSpaceReca.resolve()
        }));
        this._filterAppointmentsByDate()
    };
    _proto._isLoaded = function() {
        return (0, _instanceFactory.getResourceManager)(this.key).isLoaded() && this._isDataSourceLoaded()
    };
    ...
    _proto._appointmentsConfig = function() {
        ...
        var config = {
            ...
            getResizableStep: function() {
                return _this11._workSpace ? _this11._workSpace.positionHelper.getResizableStep() : 0
            },
            onContentReady: function() {
                var _this11$_workSpace;
                var filteredItems = (0, _instanceFactory.getAppointmentDataProvider)(_this11.key).filteredItems;
                null === (_this11$_workSpace = _this11._workSpace) || void 0 === _this11$_workSpace ? void 0 : _this11$_workSpace.option("allDayExpanded", _this11._isAllDayExpanded(filteredItems))
            }
        };
        return config
    };
    ...
    _proto._recalculateWorkspace = function() {
        ...
        this._waitAsyncTemplate((function() {
            (0, _visibility_change.triggerResizeEvent)(_this12._workSpace.$element());
            _this12._workSpace._refreshDateTimeIndication()
        }))
    };
    _proto._workSpaceConfig = function(groups, countConfig) {
        var _currentViewOptions$s2, _this13 = this;
        var currentViewOptions = this._getCurrentViewOptions();
        var scrolling = this.option("scrolling");
        ...
        var result = (0, _extend.extend)({
            ...
            onSelectionChanged: function(args) {
                _this13.option("selectedCellData", args.selectedCellData)
            },
            ...
            getHeaderHeight: function() {
                return _utils2.utils.DOM.getHeaderHeight(_this13._header)
            },
            onScrollEnd: function() {
                return _this13._appointments.updateResizableArea()
            },
    ...
    _proto._refreshWorkSpace = function(groups) {
        ...
        if (this._readyToRenderAppointments) {
            ...
            this._waitAsyncTemplate((function() {
                return _this14._workSpaceRecalculation.resolve()
            }))
        }
    };
        ...
        switch (editMode) {
            ...
            default:
                ...
                this._showRecurrenceChangeConfirm(isDeleted).done((function(editingMode) {
                    ...
                    editingMode === RECURRENCE_EDITING_MODE.OCCURENCE && _this15._excludeAppointmentFromSeries(targetAppointment, singleAppointment, exceptionDate, isDeleted, isPopupEditing, dragEvent)
                })).fail((function() {
                    return _this15._appointments.moveAppointmentBack(dragEvent)
                }))
        }
    };
    _proto._excludeAppointmentFromSeries = function(rawAppointment, newRawAppointment, exceptionDate, isDeleted, isPopupEditing, dragEvent) {
        ...
        var newAppointment = (0, _appointmentAdapter.createAppointmentAdapter)(this.key, newRawAppointment);
        ...
        if (isPopupEditing) {
            ...
            this._updateAppointment(rawAppointment, appointment.source(), (function() {
                _this16._appointments.moveAppointmentBack(dragEvent)
            }), dragEvent)
        }
    };
    ...
    _proto._getUpdatedData = function(rawAppointment) {
        ...
        (0, _instanceFactory.getResourceManager)(this.key).setResourcesToItem(rawResult, targetCell.groups);
        return rawResult
    };
    ...
    _proto.dayHasAppointment = function(day, rawAppointment, trimTime) {
        ...
        var getConvertedToTimeZone = function(date) {
            return (0, _instanceFactory.getTimeZoneCalculator)(_this19.key).createDate(date, {
                path: "toGrid"
            })
        };
        var appointment = (0, _appointmentAdapter.createAppointmentAdapter)(this.key, rawAppointment);
    ...
    _proto.setTargetedAppointmentResources = function(rawAppointment, element, appointmentIndex) {
        ...
        if (null !== groups && void 0 !== groups && groups.length) {
            var resourcesSetter = (0, _instanceFactory.getResourceManager)(this.key)._dataAccessors.setter;
            var workSpace = this._workSpace;
            var getGroups;
    ...
    _proto.showAppointmentPopup = function(rawAppointment, createNewAppointment, rawTargetedAppointment) {
        ...
        if (isCreateAppointment) {
            ...
            this._checkRecurringAppointment(rawAppointment, newTargetedAppointment, appointment.startDate, (function() {
                _this20._editAppointmentData = rawAppointment;
                _this20._appointmentPopup.show(rawAppointment, {
                    isToolbarVisible: _this20._editing.allowUpdating,
    ...
    _proto.createPopupAppointment = function() {
        ...
        var startDate = this.option("currentDate");
    ...
    _proto.showAppointmentTooltip = function(appointment, element, targetedAppointment) {
        if (appointment) {
            var settings = _utils2.utils.dataAccessors.getAppointmentSettings(element);
            var deferredColor = (0, _instanceFactory.getResourceManager)(this.key).getAppointmentColor({
    ...
    _proto.addAppointment = function(rawAppointment) {
        ...
        return this._processActionResult(addingOptions, (function(canceled) {
            ...
            _this21._expandAllDayPanel(serializedAppointment);
            return (0, _instanceFactory.getAppointmentDataProvider)(_this21.key).add(serializedAppointment).always((function(storeAppointment) {
                return _this21._onDataPromiseCompleted(StoreEventNames.ADDED, storeAppointment)
            }))
        }))
    };
        ...
        this._processActionResult(deletingOptions, (function(canceled) {
            ...
            if (!canceled) {
                (0, _instanceFactory.getAppointmentDataProvider)(this.key).remove(rawAppointment).always((function(storeAppointment) {
                    return _this22._onDataPromiseCompleted(StoreEventNames.DELETED, storeAppointment, rawAppointment)
                }))
            }
        }))
    };
