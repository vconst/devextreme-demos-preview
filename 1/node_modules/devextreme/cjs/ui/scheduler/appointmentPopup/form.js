...
var getAllDayEndDate = function(startDate) {
...
var AppointmentForm = function() {
    ...
    _proto.create = function(dataExprs, triggerResize, changeSize, appointmentData, allowTimeZoneEditing, formData) {
        ...
        var mainItems = [].concat(_toConsumableArray(this._createMainItems(dataExprs, triggerResize, changeSize, allowTimeZoneEditing)), _toConsumableArray(resourceManager.getEditors()));
    ...
    _proto.setEditorsType = function(startDateExpr, endDateExpr, allDay) {
    ...
    _proto.updateFormData = function(formData, dataExprs) {
        this.semaphore.take();
    ...
    _createClass(AppointmentForm, [{
        ...
        set: function(value) {
            ...
            null === recurrenceEditor || void 0 === recurrenceEditor ? void 0 : null === (_recurrenceEditor$_re = recurrenceEditor._recurrenceForm) || void 0 === _recurrenceEditor$_re ? void 0 : _recurrenceEditor$_re.option("readOnly", value)
        }
    }, {
        key: "formData",
        get: function() {
