...
var HorizontalVirtualScrolling = function(_VirtualScrollingBase2) {
    ...
    _proto4._updateStateVirtualItemSizes = function(virtualItemSizeBefore, virtualItemSizeAfter) {
        if (!this.isRTL) {
            _VirtualScrollingBase2.prototype._updateStateVirtualItemSizes.call(this, virtualItemSizeBefore, virtualItemSizeAfter)
        } else {
            var state = this.state;
