...
var ViewDataGenerator = function() {
    ...
    _proto.getViewDataFromMap = function(viewDataMap, options) {
    ...
    _proto.prepareCellData = function(options, rowIndex, columnIndex) {
        var groups = options.groups,
            tableAllDay = options.tableAllDay,
            startDayHour = options.startDayHour,
            endDayHour = options.endDayHour,
            interval = options.interval,
            hoursInterval = options.hoursInterval;
        var groupsList = (0, _utils.getAllGroups)(groups);
        var startDate = (0, _base.getDateByCellIndices)(options, rowIndex, columnIndex, this._calculateCellIndex, this.getCellCountInDay(startDayHour, endDayHour, hoursInterval));
    ...
    _proto._calculateCellIndex = function(rowIndex, columnIndex, rowCount, columnCount) {
        return (0, _base.calculateCellIndex)(rowIndex, columnIndex, rowCount, columnCount)
    };
