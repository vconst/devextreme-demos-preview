...
var ViewDataProvider = function() {
    ...
    _proto._transformRenderOptions = function(renderOptions) {
        ...
        return _extends({}, restOptions, {
            ...
            isVerticalGrouping: (0, _utils.isVerticalGroupingApplied)(groups, groupOrientation),
            isHorizontalGrouping: (0, _utils.isHorizontalGroupingApplied)(groups, groupOrientation),
            isGroupedByDate: (0, _utils.isGroupingByDate)(groups, groupOrientation, groupByDate),
