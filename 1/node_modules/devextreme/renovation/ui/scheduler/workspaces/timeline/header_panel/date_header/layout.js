...
var viewFunction = function(_ref) {
    ...
    return (0, _inferno.createFragment)(dateHeaderMap.map((function(dateHeaderRow, rowIndex) {
        var rowsCount = dateHeaderMap.length;
    ...
    _createClass(TimelineDateHeaderLayout, [{
        ...
        get: function() {
            var _this$props2 = this.props,
                restProps = (_this$props2.dateCellTemplate, _this$props2.dateHeaderMap, _this$props2.groupByDate, _this$props2.groupOrientation, _this$props2.groups, _this$props2.timeCellTemplate, _objectWithoutProperties(_this$props2, ["dateCellTemplate", "dateHeaderMap", "groupByDate", "groupOrientation", "groups", "timeCellTemplate"]));
            return restProps
        }
    }]);
