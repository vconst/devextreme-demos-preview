...
var _excluded = ["className", "isSetTitleClass", "visible"];
    ...
    _createClass(AllDayPanelTitle, [{
        ...
        get: function() {
            var _this$props = this.props,
                restProps = (_this$props.className, _this$props.isSetTitleClass, _this$props.visible, _objectWithoutProperties(_this$props, _excluded));
            return restProps
        }
    }]);
