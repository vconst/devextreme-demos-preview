...
var Scrollable = function(_BaseComponent) {
    ...
    _proto.update = function() {
        return this.viewRef.update()
    };
    _proto.release = function() {
        return this.viewRef.release()
    };
    _proto.refresh = function() {
        return this.viewRef.refresh()
    };
    ...
    _proto.scrollToElement = function(element) {
        return this.viewRef.scrollToElement(this._patchElementParam(element))
    };
    ...
    _proto.getScrollElementPosition = function(element, direction) {
        return this.viewRef.getScrollElementPosition(this._patchElementParam(element), direction)
    };
