...
var ScrollView = function(_ScrollViewWrapper) {
    ...
    _proto.scrollToElementTopLeft = function(element) {
        var _this$viewRef7;
        var params = [this._patchElementParam(element)];
        return null === (_this$viewRef7 = this.viewRef) || void 0 === _this$viewRef7 ? void 0 : _this$viewRef7.scrollToElementTopLeft.apply(_this$viewRef7, _toConsumableArray(params.slice(0, arguments.length)))
    };
    ...
    _proto.isFull = function() {
        var _this$viewRef16;
        return null === (_this$viewRef16 = this.viewRef) || void 0 === _this$viewRef16 ? void 0 : _this$viewRef16.isFull.apply(_this$viewRef16, arguments)
    };
