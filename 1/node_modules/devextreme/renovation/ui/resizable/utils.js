...
exports.filterOffsets = exports.getMovingSides = exports.getAreaFromObject = exports.getAreaFromElement = void 0;
...
function getBorderWidth(el, direction) {
    if (!(0, _type.isWindow)(el)) {
        var borderWidth = el.style[borderStyles[direction]];
