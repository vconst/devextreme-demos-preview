...
var ResizableContainer = function(_InfernoComponent) {
    ...
    _proto.createEffects = function() {
        return [new _vdom.InfernoEffect(this.forwardRefInitEffect, [])]
    };
...
function __createDefaultProps() {
    return _extends({}, ResizableContainerProps, (0, _utils.convertRulesToOptions)([]))
}
...
function defaultOptions(rule) {
    ...
    ResizableContainer.defaultProps = _extends({}, __createDefaultProps(), (0, _utils.convertRulesToOptions)(__defaultOptionRules))
}
