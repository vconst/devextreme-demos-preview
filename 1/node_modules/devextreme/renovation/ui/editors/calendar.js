...
var Calendar = function(_BaseInfernoComponent) {
    ...
    _createClass(Calendar, [{
        ...
        get: function() {
            var _this$props$value = _extends({}, this.props, {
                ...
                restProps = (_this$props$value._todayDate, _this$props$value.accessKey, _this$props$value.activeStateEnabled, _this$props$value.className, _this$props$value.defaultValue, _this$props$value.disabled, _this$props$value.firstDayOfWeek, _this$props$value.focusStateEnabled, _this$props$value.hasFocus, _this$props$value.height, _this$props$value.hint, _this$props$value.hoverStateEnabled, _this$props$value.max, _this$props$value.min, _this$props$value.onClick, _this$props$value.onKeyDown, _this$props$value.rtlEnabled, _this$props$value.tabIndex, _this$props$value.value, _this$props$value.valueChange, _this$props$value.visible, _this$props$value.width, _objectWithoutProperties(_this$props$value, _excluded));
            return restProps
        }
    }]);
    return Calendar
