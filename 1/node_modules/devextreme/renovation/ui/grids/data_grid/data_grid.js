...
var defaultOptionRules = (0, _utils.createDefaultOptionRules)([{
    ...
    device: function() {
        return true === _browser.default.webkit
    },
    options: {
        loadingTimeout: 30
    }
...
var DataGrid = function(_InfernoWrapperCompon) {
    ...
    _proto.createEffects = function() {
        return [new _vdom.InfernoEffect(this.updateOptions, [this.props, this.__state_filterValue, this.__state_focusedColumnIndex, this.__state_focusedRowIndex, this.__state_focusedRowKey, this.__state_selectedRowKeys, this.__state_selectionFilter]), new _vdom.InfernoEffect(this.dispose, []), new _vdom.InfernoEffect(this.setupInstance, []), (0, _vdom.createReRenderEffect)()]
    };
    _proto.updateEffects = function() {
        var _this$_effects$;
        null === (_this$_effects$ = this._effects[0]) || void 0 === _this$_effects$ ? void 0 : _this$_effects$.update([this.props, this.__state_filterValue, this.__state_focusedColumnIndex, this.__state_focusedRowIndex, this.__state_focusedRowKey, this.__state_selectedRowKeys, this.__state_selectionFilter])
    };
