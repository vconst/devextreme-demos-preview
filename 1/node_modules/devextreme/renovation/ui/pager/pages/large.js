...
var PagesLarge = function(_BaseInfernoComponent) {
    ...
    _proto.generatePageIndexes = function() {
        ...
        if ((void 0 !== this.props.pageIndex ? this.props.pageIndex : this.state.pageIndex) === slidingWindowIndexes[0]) {
            startIndex = (void 0 !== this.props.pageIndex ? this.props.pageIndex : this.state.pageIndex) - 1
        } else if ((void 0 !== this.props.pageIndex ? this.props.pageIndex : this.state.pageIndex) === slidingWindowIndexes[slidingWindowIndexes.length - 1]) {
            startIndex = (void 0 !== this.props.pageIndex ? this.props.pageIndex : this.state.pageIndex) + 2 - PAGES_LIMITER
        } else if ((void 0 !== this.props.pageIndex ? this.props.pageIndex : this.state.pageIndex) < PAGES_LIMITER) {
            startIndex = 1
        } else if ((void 0 !== this.props.pageIndex ? this.props.pageIndex : this.state.pageIndex) >= pageCount - PAGES_LIMITER) {
    ...
    _createClass(PagesLarge, [{
        ...
        get: function() {
            ...
            if (this.canReuseSlidingWindow(pageCount, void 0 !== this.props.pageIndex ? this.props.pageIndex : this.state.pageIndex)) {
                var slidingWindowIndexes = this.slidingWindowState.slidingWindowIndexes;
            ...
            return rtlPageIndexes.map((function(index) {
                return function(index) {
                    var pagerProps = "low" === index || "high" === index ? null : {
                        ...
                        selected: (void 0 !== _this2.props.pageIndex ? _this2.props.pageIndex : _this2.state.pageIndex) === index
                    };
                    return {
                        key: index.toString(),
