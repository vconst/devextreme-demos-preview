...
var ComponentWrapper = function(_DOMComponent) {
    ...
    _proto._dispose = function() {
        ...
        (0, _inferno.render)((0, _infernoCreateElement.createElement)(containerNode.tagName, this.elementAttr), parentNode);
        delete parentNode.$V;
        ...
        elements.forEach((function(name) {
            if (name in widgetProps) {
                ...
                if ((0, _type.isRenderer)(value)) {
                    widgetProps[name] = _this2._patchElementParam(value)
                }
            }
        }));
        return widgetProps
    ...
    _proto._extractDefaultSlot = function() {
        ...
        if (this.option("_hasAnonymousTemplateContent")) {
            return (0, _infernoCreateElement.createElement)(_inferno.Fragment, {}, (0, _infernoCreateElement.createElement)("div", {
                style: {
                    display: "none"
                },
                ref: function(dummyDivRef) {
                    if (dummyDivRef) {
