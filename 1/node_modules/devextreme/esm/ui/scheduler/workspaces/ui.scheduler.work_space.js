...
class SchedulerWorkSpace extends WidgetObserver {
    ...
    _getDateGenerationOptions() {
        ...
        var isOldRender = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : false;
        return {
            startDayHour: this.option("startDayHour"),
            endDayHour: this.option("endDayHour"),
            isWorkView: this.isWorkView,
            ...
            startViewDate: isOldRender ? this.getStartViewDate() : void 0,
            rowCountBase: this._getRowCount(),
            columnCountBase: this._getCellCount(),
            tableAllDay: this._getTableAllDay(),
            firstDayOfWeek: this._firstDayOfWeek()
    ...
    getGroupWidth(groupIndex) {
        var cellWidth = this.getCellWidth();
        var result = this._getCellCount() * cellWidth;
        if (this.isVirtualScrolling()) {
    ...
    _oldRender_getAllDayCellData(groupIndex) {
        return (cell, rowIndex, columnIndex) => {
            ...
            var startDate = getDateByCellIndices(options, rowIndex, validColumnIndex, options.calculateCellIndex, this._getCellCountInDay());
