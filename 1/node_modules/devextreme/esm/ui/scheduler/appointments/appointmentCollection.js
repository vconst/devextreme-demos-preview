...
class SchedulerAppointments extends CollectionWidget {
    ...
    _sortAppointmentsByStartDate(appointments) {
        appointments.sort(function(a, b) {
            var result = 0;
            var firstDate = new Date(ExpressionUtils.getField(this.option("key"), "startDate", a.settings || a)).getTime();
            var secondDate = new Date(ExpressionUtils.getField(this.option("key"), "startDate", b.settings || b)).getTime();
