...
export default class ScrollView extends ScrollViewWrapper {
    ...
    scrollToElementTopLeft(element) {
        var _this$viewRef7;
        var params = [this._patchElementParam(element)];
        return null === (_this$viewRef7 = this.viewRef) || void 0 === _this$viewRef7 ? void 0 : _this$viewRef7.scrollToElementTopLeft(...params.slice(0, arguments.length))
    }
    scrollHeight() {
        var _this$viewRef8;
    ...
    isFull() {
        var _this$viewRef16;
        return null === (_this$viewRef16 = this.viewRef) || void 0 === _this$viewRef16 ? void 0 : _this$viewRef16.isFull(...arguments)
    }
    startLoading() {
        var _this$viewRef17;
