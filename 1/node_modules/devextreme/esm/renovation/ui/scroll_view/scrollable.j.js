...
export default class Scrollable extends ScrollableWrapper {
    ...
    scrollBy(distance) {
        var _this$viewRef3;
        return null === (_this$viewRef3 = this.viewRef) || void 0 === _this$viewRef3 ? void 0 : _this$viewRef3.scrollBy(...arguments)
    }
    updateHandler() {
        var _this$viewRef4;
        return null === (_this$viewRef4 = this.viewRef) || void 0 === _this$viewRef4 ? void 0 : _this$viewRef4.updateHandler(...arguments)
    }
    release() {
        var _this$viewRef5;
        return null === (_this$viewRef5 = this.viewRef) || void 0 === _this$viewRef5 ? void 0 : _this$viewRef5.release(...arguments)
    }
    refresh() {
        var _this$viewRef6;
        return null === (_this$viewRef6 = this.viewRef) || void 0 === _this$viewRef6 ? void 0 : _this$viewRef6.refresh(...arguments)
    }
    scrollTo(targetLocation) {
        var _this$viewRef7;
        return null === (_this$viewRef7 = this.viewRef) || void 0 === _this$viewRef7 ? void 0 : _this$viewRef7.scrollTo(...arguments)
    }
    ...
    scrollToElementTopLeft(element) {
        var _this$viewRef17;
        var params = [this._patchElementParam(element)];
        return null === (_this$viewRef17 = this.viewRef) || void 0 === _this$viewRef17 ? void 0 : _this$viewRef17.scrollToElementTopLeft(...params.slice(0, arguments.length))
    }
    startLoading() {
        var _this$viewRef18;
        return null === (_this$viewRef18 = this.viewRef) || void 0 === _this$viewRef18 ? void 0 : _this$viewRef18.startLoading(...arguments)
    }
    finishLoading() {
        var _this$viewRef19;
        return null === (_this$viewRef19 = this.viewRef) || void 0 === _this$viewRef19 ? void 0 : _this$viewRef19.finishLoading(...arguments)
    }
    _getActionConfigs() {
        return {
            onScroll: {},
