...
export var viewFunction = _ref => {
    ...
    return createFragment(dateHeaderMap.map((dateHeaderRow, rowIndex) => createComponentVNode(2, Row, {
...
export class DateHeaderLayout extends BaseInfernoComponent {
    ...
    get restAttributes() {
        var _this$props = this.props,
            restProps = _objectWithoutPropertiesLoose(_this$props, ["dateCellTemplate", "dateHeaderMap", "groupByDate", "groupOrientation", "groups", "timeCellTemplate"]);
        return restProps
    }
    render() {
