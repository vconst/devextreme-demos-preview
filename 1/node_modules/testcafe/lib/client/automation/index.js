...
(function () {
    ...
    ***************************************************************************** */
    ...
    function findDraggableElement(element) {
        ...
        while (parentNode) {
            if (parentNode.draggable)
                return parentNode;
            parentNode = nativeMethods$4.nodeParentNodeGetter.call(parentNode);
        }
        return null;
    }
    var MoveAutomation = /** @class */ (function () {
        ...
        MoveAutomation.prototype._movingStep = function () {
            ...
            if (this.touchMode && !this.holdLeftButton) {
                ...
                this.startTime = nativeMethods$4.dateNow();
                ...
                var currentTime = Math.min(nativeMethods$4.dateNow(), this.endTime);
            ...
            return underCursor()
                ...
                if (draggable && featureDetection.hasDataTransfer && !_this.skipDefaultDragBehavior) {
                    ...
                    if (isLink || domUtils$2.isImgElement(_this.dragElement)) {
                        ...
                        var outerHTML = htmlUtils.cleanUpHtml(nativeMethods$4.elementOuterHTMLGetter.call(_this.dragElement));
    ...
    function _updateSelectionAfterDeletionContent(element, selection) {
        ...
        var startParent = nativeMethods$8.nodeParentNodeGetter.call(startNode);
    ...
    function _typeTextInElementNode(elementNode, text, offset) {
        ...
        var parent = nativeMethods$8.nodeParentNodeGetter.call(elementNode);
        if (domUtils$7.getTagName(elementNode) === 'br')
            parent.insertBefore(nodeForTyping, elementNode);
        else if (offset > 0) {
            var childNodes = nativeMethods$8.nodeChildNodesGetter.call(elementNode);
    ...
    function getDeepActiveElement(currentDocument) {
        ...
        if (activeElement && testCafeCore.domUtils.isIframeElement(activeElement) &&
            nativeMethods$9.contentDocumentGetter.call(activeElement)) {
            try {
                activeElementInIframe = getDeepActiveElement(nativeMethods$9.contentDocumentGetter.call(activeElement));
            }
    ...
    function activeElementHasNegativeTabIndex(doc) {
        var activeElement = nativeMethods$9.documentActiveElementGetter.call(doc);
    ...
    var PressAutomation = /** @class */ (function () {
        ...
        PressAutomation.prototype.run = function () {
            ...
            if (!isIframeWindow(window) && activeElementIsIframe && nativeMethods$a.contentWindowGetter.call(activeElement)) {
                var msg = {
                    cmd: PRESS_REQUEST_CMD,
                    keyCombinations: this.keyCombinations,
                    options: this.options,
                };
                return testCafeCore.sendRequestToFrame(msg, PRESS_RESPONSE_CMD, nativeMethods$a.contentWindowGetter.call(activeElement));
            }
    ...
    nativeMethods$b.objectDefineProperty(window, '%testCafeAutomation%', { configurable: true, value: exports$1 });
    // eslint-disable-next-line no-undef
    hammerhead__default.on(evalIframeScript, function (e) { return initTestCafeAutomation(nativeMethods$b.contentWindowGetter.call(e.iframe), true); });
