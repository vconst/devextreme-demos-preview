...
(function () {
    ...
    ***************************************************************************** */
    ...
    function _updateSelectionAfterDeletionContent(element, selection) {
        ...
        var startParent = nativeMethods$7.nodeParentNodeGetter.call(startNode);
    ...
    function _typeTextInElementNode(elementNode, text, offset) {
        ...
        var parent = nativeMethods$7.nodeParentNodeGetter.call(elementNode);
        if (domUtils$7.getTagName(elementNode) === 'br')
            parent.insertBefore(nodeForTyping, elementNode);
        else if (offset > 0) {
            var childNodes = nativeMethods$7.nodeChildNodesGetter.call(elementNode);
    ...
    function getDeepActiveElement(currentDocument) {
        ...
        if (activeElement && testCafeCore.domUtils.isIframeElement(activeElement) &&
            nativeMethods$8.contentDocumentGetter.call(activeElement)) {
            try {
                activeElementInIframe = getDeepActiveElement(nativeMethods$8.contentDocumentGetter.call(activeElement));
            }
    ...
    var PressAutomation = /** @class */ (function () {
        ...
        PressAutomation.prototype.run = function () {
            ...
            if (!isIframeWindow(window) && activeElementIsIframe && nativeMethods$9.contentWindowGetter.call(activeElement)) {
                var msg = {
                    cmd: PRESS_REQUEST_CMD,
                    keyCombinations: this.keyCombinations,
                    options: this.options
                };
                return testCafeCore.sendRequestToFrame(msg, PRESS_RESPONSE_CMD, nativeMethods$9.contentWindowGetter.call(activeElement));
            }
    ...
    nativeMethods$a.objectDefineProperty(window, '%testCafeAutomation%', { configurable: true, value: exports$1 });
    // eslint-disable-next-line no-undef
    hammerhead__default.on(evalIframeScript, function (e) { return initTestCafeAutomation(nativeMethods$a.contentWindowGetter.call(e.iframe), true); });
